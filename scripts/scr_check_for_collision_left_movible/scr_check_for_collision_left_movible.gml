...
if(!place_meeting(movible.sensor.x - 6, movible.sensor.y, obj_muro)){
	//show_debug_message("pase esta prueba");
	if(!place_meeting(movible.sensor_lado.x - movible.sensor_lado.sprite_width + 1, movible.sensor.y , obj_movible)){
		return 1;
	}else{
